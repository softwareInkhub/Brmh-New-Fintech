...
function SlicePreviewComponent({ sliceData, file, selectedFields: initialSelectedFields }: { sliceData: string[][]; file: FileData; selectedFields: string[] }) {
  ...
  const handleCheckDuplicates = async () => {
    ...
    try {
      ...
      console.log('BankFiles - Duplicate check parameters:');
      ...
      console.log('BankFiles - API Response status:', res.status);
      console.log('BankFiles - API Response data type:', typeof existing);
      console.log('BankFiles - API Response is array:', Array.isArray(existing));
      console.log('BankFiles - API Response length:', existing?.length);
      console.log('BankFiles - API Response sample:', existing?.slice(0, 2));
      ...
      console.log('BankFiles - Selected fields (original):', selectedFields);
      console.log('BankFiles - Unique fields to check:', uniqueFields);
      console.log('BankFiles - Slice data length:', sliceData.length);
      console.log('BankFiles - Slice data headers:', sliceData[0]);
